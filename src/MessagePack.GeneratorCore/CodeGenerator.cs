...
namespace MessagePackCompiler
{
    public class CodeGenerator
    {
        ...
        /// <param name="namespace">The namespace for the generated type to be created in.</param>
        /// <param name="useMapMode"></param>
        /// <param name="multipleIfDirectiveOutputSymbols">A comma-delimited list of... ?</param>
        /// <returns></returns>
